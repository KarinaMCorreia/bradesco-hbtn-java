...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Map<Integer, Long>> pessoas1 =
                ConsultaPessoas.obterContagemPessoasPorCargoEIdade(todasPessoas);

        Map<String, Map<Integer, Long>> pessoas2 =
                ConsultaPessoas.obterContagemPessoasPorCargoEIdade(
                        List.of(pessoa1, pessoa2, pessoa3, pessoa4, pessoa9, pessoa10)
                );

        Map<String, Map<Integer, Long>> pessoas3 =
                ConsultaPessoas.obterContagemPessoasPorCargoEIdade(
